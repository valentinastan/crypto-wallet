...
//   let allCoins;
//   //get all coins
//   refreshData(nIntervId, params).then(data => {
...
// const getAllCoingeckoTokens = async (params) => {
...
// const refreshData = (nIntervId, params) => {
//   // check if already an interval has been set up
//   if (!nIntervId) {
//     nIntervId = setInterval(getAllCoingeckoTokens, 1000, params);
//   }
// }
